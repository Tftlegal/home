...
read -p "Please input CHR version to deploy (6.38.2, 6.40.1, 6.49.2, 7.1, 7.1rc7, etc):" version
...
#chek
#wget https://download2.mikrotik.com/routeros/7.1/chr-7.1.img.zip
#wget https://download.mikrotik.com/routeros/7.1rc7/chr-7.1rc7.img.zip
